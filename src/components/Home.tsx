...
const Home: React.FC<Props> = ({ resumeUrl }) => {
    ...
    const textHoverVariants: Variants = {
        ...
        hover: { y: [-1, 2, -3, 1, 0], scaleY: [1, 1.2, .7, 1, 1.1], color: "#0ee958" },
                ...
                {!isMobile &&
                    <div className="landing-right-section">
                        <motion.svg
                            ...
                            width="352" height="400" viewBox="0 0 125 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <motion.path
                                initial={{ fill: "none", x: 25 }}
                                animate={{ fill: "black", x: 0 }}
                                transition={{ duration: 1, type: "spring" }}
                                d="M102.89 99.51H57.24v-82c0-1.24-1-2.24-2.24-2.24H33.11c-1.24 0-2.24 1-2.24 2.24v100.96c0 1.24 1 2.24 2.24 2.24h69.79c1.24 0 2.24-1 2.24-2.24v-16.72a2.251 2.251 0 0 0-2.25-2.24z"fill="black" />
                            <motion.path
                                ...
                                transition={{ duration: 10, type: "tween", repeat: Infinity, repeatType: "mirror", repeatDelay: 1, delay: 2 }}
                                 d="M102.89 99.51H57.24v-82c0-1.24-1-2.24-2.24-2.24H33.11c-1.24 0-2.24 1-2.24 2.24v100.96c0 1.24 1 2.24 2.24 2.24h69.79c1.24 0 2.24-1 2.24-2.24v-16.72a2.251 2.251 0 0 0-2.25-2.24z"fill="#0ee958"
                            />
                        </motion.svg>
                    </div>
                }
